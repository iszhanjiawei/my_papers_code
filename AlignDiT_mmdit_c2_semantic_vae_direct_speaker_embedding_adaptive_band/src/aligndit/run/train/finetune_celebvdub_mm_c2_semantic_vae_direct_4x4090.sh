...
# Original C2 optimization on fixed 64D/40 Hz Semantic-VAE representations.
...
echo "Launching Semantic-VAE Direct-C2: four RTX 4090 GPUs, BF16, 3,600 frames/GPU" >&2
exec env \
    ...
    "$python_bin" -u -m accelerate.commands.launch \
        ...
        src/aligndit/script/train/finetune_semantic_vae_c2_direct.py \
        --config-name finetune_celebvdub_mm_c2_semantic_vae_direct
