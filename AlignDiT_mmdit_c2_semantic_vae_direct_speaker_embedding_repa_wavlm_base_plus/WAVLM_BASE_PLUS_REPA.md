# Single-teacher WavLM-Base+ REPA
...
- Weight: `repa_lambda=0.1`. Existing diffusion loss and the delayed CTC schedule
...
```text
/zjw524/projects/data/ckpts/AlignDiT_MMDiT_qknorm_ca_c2_semantic_vae_direct_speaker_repa_wavlm_base_plus_40hz_CelebVDub_char
```
...
No extraction or training process is started merely by adding this variant.
