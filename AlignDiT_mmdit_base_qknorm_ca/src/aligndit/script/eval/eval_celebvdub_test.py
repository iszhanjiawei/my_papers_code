...
def get_args():
    ...
    parser.add_argument("--wavlm_ckpt", type=str, default="/home/zjw524/alignDiT_pretrain_models/wavlm_large_finetune.pth")
    parser.add_argument("--asr_ckpt", type=str, default="/home/zjw524/alignDiT_pretrain_models/large-v3.pt")
    parser.add_argument("--emo_ckpt", type=str, default="/home/zjw524/projects/data/emotion2vec_plus_large")
