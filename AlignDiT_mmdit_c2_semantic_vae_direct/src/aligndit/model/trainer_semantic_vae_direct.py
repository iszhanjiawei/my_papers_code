"""Original C2 trainer with strict S2c EMA loading and no altered optimization policy."""
...
class SemanticVaeDirectC2Trainer(Trainer_VT):
    """Preserve C2 training while enforcing the one permitted parent migration."""
