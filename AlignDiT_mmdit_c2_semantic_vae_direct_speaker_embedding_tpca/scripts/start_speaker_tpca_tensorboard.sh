...
run_name="AlignDiT_MMDiT_C2_SemanticVAE_Direct_Speaker_TPCA_CTC003_Warmup10k30k_semantic_vae_40hz_CelebVDub_char"
...
setsid "${ROOT_PREFIX}/zjw524/ENTER/envs/aligndit/bin/python" -u -m tensorboard.main \
    ...
    > "$project_root/logs/tensorboard_speaker_tpca_${port}.log" 2>&1 < /dev/null &
tb_pid=$!
