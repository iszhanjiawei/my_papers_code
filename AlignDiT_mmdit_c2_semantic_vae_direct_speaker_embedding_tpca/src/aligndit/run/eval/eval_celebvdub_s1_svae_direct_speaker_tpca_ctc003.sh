#!/usr/bin/env bash
# Generate TPCA S1 speech and evaluate SPKSIM, WER, EMOSIM and AVSync.
set -euo pipefail
...
export OUTPUT_DIR="${OUTPUT_DIR:-$checkpoint_dir/eval_s1_${CKPT_STEP}_speaker_tpca_cfgv${CFG_VIDEO}}"
...
bash "$script_dir/infer_celebvdub_s1_svae_direct_speaker_tpca_ctc003.sh"
