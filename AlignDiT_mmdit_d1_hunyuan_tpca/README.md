...
这是独立的 CelebVDub TPCA 实验副本。实现、损失、验证和训练入口见 [TPCA.md](TPCA.md)。
正式训练配置为 `finetune_celebvdub_mm_d1_hunyuan_tpca.yaml`，启动脚本为
`scripts/train_tpca_4x4090.sh`。下面保留上游 AlignDiT 文档。
