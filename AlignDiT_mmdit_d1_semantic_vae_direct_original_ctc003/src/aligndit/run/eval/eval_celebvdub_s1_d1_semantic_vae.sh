#!/usr/bin/env bash
# Original D1 Semantic-VAE / CTC warmup 10k->30k: inference and four historical metrics.
...
checkpoint_dir="${CHECKPOINT_DIR:-${ROOT_PREFIX}/zjw524/projects/data/ckpts/AlignDiT_MMDiT_D1_SemanticVAE_Original_CTC003_Warmup10k30k_40hz_CelebVDub_char}"
selector="${1:-last}"
step_args=()
