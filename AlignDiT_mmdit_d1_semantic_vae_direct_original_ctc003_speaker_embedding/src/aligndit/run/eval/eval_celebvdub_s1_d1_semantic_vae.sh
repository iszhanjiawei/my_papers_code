#!/usr/bin/env bash
# Original D1 Semantic-VAE / fixed CTC 0.03: inference and the historical WER / SIM / EMOSIM / AVSync metrics.
...
checkpoint_dir="${CHECKPOINT_DIR:-${ROOT_PREFIX}/zjw524/projects/data/ckpts/AlignDiT_MMDiT_D1_SemanticVAE_Original_CTC003_Fixed_40hz_CelebVDub_char}"
selector="${1:-last}"
step_args=()
