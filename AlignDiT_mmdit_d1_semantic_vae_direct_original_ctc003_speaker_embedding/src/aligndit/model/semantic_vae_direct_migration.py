...
def migrate_s2c_ema_into_model(
    ...
    *,
    ...
    # Exactly one additional tensor is allowed for speaker conditioning. All
    # parent keys and the original D1 migration contract remain unchanged.
    ...
    if has_speaker:
        ...
        if (
            ...
            raise RuntimeError("D1 speaker migration requires a zero-initialized Linear(192, 768) for blocks 6..17")
    actual_counts = (
        len(source_state),
        len(target_state),
