...
export OUTPUT_DIR="${OUTPUT_DIR:-$checkpoint_dir/eval_s1_${CKPT_STEP}_speaker_repa_baseplus_cfgv${CFG_VIDEO}}"
...
bash "$script_dir/infer_celebvdub_s1_svae_direct_speaker_repa_wavlm_base_plus.sh"
