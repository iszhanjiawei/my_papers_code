...
cd "$project_root"
port="${TENSORBOARD_PORT:-6008}"
run_name="AlignDiT_MMDiT_qknorm_ca_c2_semantic_vae_direct_speaker_repa_wavlm_base_plus_lambda005_semantic_vae_40hz_CelebVDub_char"
...
setsid "${ROOT_PREFIX}/zjw524/ENTER/envs/aligndit/bin/python" -u \
    "${ROOT_PREFIX}/zjw524/ENTER/envs/aligndit/bin/tensorboard" \
