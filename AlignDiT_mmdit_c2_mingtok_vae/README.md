...
> **Experiment snapshot:** this directory is the strict CelebVDub C2 variant
> using raw sampled MingTok 64D/50 Hz acoustic latents and scratch AlignDiT
> initialization.  Use the dedicated workflow in [MINGTOK_C2.md](MINGTOK_C2.md).
> The upstream mel/LRS3 commands below are retained only because this is an
> independent full-project snapshot; they are not the entry points for this
> experiment.
