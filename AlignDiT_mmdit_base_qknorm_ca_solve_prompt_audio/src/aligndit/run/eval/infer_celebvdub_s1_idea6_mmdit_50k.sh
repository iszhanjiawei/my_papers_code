...
CKPT_PATH=${ROOT_PREFIX}/zjw524/projects/data/ckpts/AlignDiT_MMDiT_qknorm_ca_prompt_isolated_stagewise_finetune_hifigan_16k_CelebVDub_char/model_50000.pt
CKPT_STEP=50000
