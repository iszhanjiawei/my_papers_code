...
# the D1 Hunyuan dual text-CA / all-head RoPE checkpoints at 150k and 200k.
...
EXP_NAME=finetune_celebvdub_mm_d1_hunyuan_dual_ca_allrope
CKPT_DIR="${ROOT_PREFIX}/zjw524/projects/data/ckpts/AlignDiT_MMDiT_D1_HunyuanDualCA_AllRoPE_6MM12A_CTC6_12_finetune_hifigan_16k_CelebVDub_char"
EXPECTED_ITEMS=213
