#!/bin/bash
# D1 on one 4×RTX 4090 server: six MM-DiT blocks, twelve text-free audio blocks,
# and CTC heads at the stage boundary after blocks 6 and 12.
...
${ROOT_PREFIX}/zjw524/ENTER/envs/aligndit/bin/python -u -m accelerate.commands.launch \
    ...
    --num_processes 4 \
    --main_process_port 29565 \
    src/aligndit/script/train/finetune.py \
    --config-name finetune_celebvdub_mm_d1_6mm12audio_dual_ctc6_12
