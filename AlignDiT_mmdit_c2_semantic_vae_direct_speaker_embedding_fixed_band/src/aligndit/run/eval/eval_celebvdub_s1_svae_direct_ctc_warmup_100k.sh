#!/bin/bash
# Inference + evaluation: Direct-C2 CTC warmup, step 100k, CelebV-Dub Setting 1.
...
checkpoint_dir="${ROOT_PREFIX}/zjw524/projects/data/ckpts/AlignDiT_MMDiT_qknorm_ca_c2_semantic_vae_direct_c2_ctc001_warmup10k30k_40hz_CelebVDub_char"
checkpoint="$checkpoint_dir/model_100000.pt"
config="src/aligndit/config/finetune_celebvdub_mm_c2_semantic_vae_direct_ctc_warmup.yaml"
step=100000
output_dir="$checkpoint_dir/eval_s1_100000"
...
echo "===== [1/5] Generate 213 Semantic-VAE waveforms ====="
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=3 PYTHONPATH="$avhubert_fairseq:src" \
...
echo "===== ALL DONE: Direct-C2 CTC warmup @ step ${step} ====="
