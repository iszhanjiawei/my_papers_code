...
> This isolated snapshot implements the CelebVDub D1 scratch experiment with
> MMAudio-style Audio/Video/Text Joint Attention. See
> [MMAUDIO_AVT_D1_SCRATCH.md](MMAUDIO_AVT_D1_SCRATCH.md) for the fixed
> architecture and initialization contract.

The formal four-GPU CelebVDub scratch run for this snapshot is:
